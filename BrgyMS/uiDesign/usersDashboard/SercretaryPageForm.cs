...
namespace BrgyMS.uiDesign.usersDashboard {
    public partial class SercretaryPageForm : Form {
        ...
        private void picUserDashboardIcon_Click(object sender, EventArgs e) {
            if (dashboard == null) {
                dashboard = new();
            }
            Cursor = Cursors.WaitCursor;
        ...
        private void picUserLogs_Click(object sender, EventArgs e) {
            if (logsControl == null) {
                logsControl = new();
            }
            Cursor = Cursors.WaitCursor;
        ...
        private void picUserRequestDocs_Click(object sender, EventArgs e) {
            if (docs == null) {
                docs = new();
            }
            Cursor = Cursors.WaitCursor;
